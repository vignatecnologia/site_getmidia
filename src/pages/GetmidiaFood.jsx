...
const GetmidiaFood = () => {
    ...
    React.useEffect(() => {
        const fetchImages = async () => {
            try {
                const { data } = await apiClient.get('/api/site-gallery/getmidia-food');
    ...
    return (
        <div className="min-h-screen bg-gray-900 text-white font-sans">
            ...
            <section className="pt-32 pb-20 relative overflow-hidden">
                <div className="absolute top-0 right-0 w-[50%] h-full bg-red-500/5 blur-3xl rounded-l-full" />
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        ...
                        >
                            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-red-500/10 border border-red-500/20 text-red-500 font-medium mb-6">
                                <Utensils className="w-4 h-4" />
                                <span>GetMídia Food</span>
                            </div>
                            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
                                Deixe seu cardápio <span className="text-red-500">irresistível</span>
                            </h1>
                            ...
                            <div className="mt-8 grid grid-cols-2 gap-x-6 gap-y-3 text-sm text-gray-400">
                                <div className="flex items-center gap-2">
                                    ...
                                    <span>Fotos apetitosas</span>
                                </div>
                                <div className="flex items-center gap-2">
                                    <CheckCircle className="w-4 h-4 text-green-500" />
                                    <span>Cenários temáticos</span>
                                </div>
                                <div className="flex items-center gap-2">
                                    <CheckCircle className="w-4 h-4 text-green-500" />
                                    <span>Fumaça e vapor</span>
                                </div>
                                <div className="flex items-center gap-2">
                                    <CheckCircle className="w-4 h-4 text-green-500" />
            ...
            <section id="demo" className="py-20 bg-gray-900 border-t border-gray-800">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl font-bold text-white mb-4">Galeria de Pratos</h2>
                        <p className="text-gray-400">Veja o que você pode criar com o GetMídia Food</p>
                    </div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        {allGalleryItems.map((item) => (
                            <div
                                ...
                                className="aspect-square bg-gray-800 rounded-xl overflow-hidden border border-gray-700 hover:border-red-500/50 transition-colors group relative cursor-pointer"
                            >
                                <img
                                    src={item.image}
                                    alt={item.title}
