    ...
    const handleDelete = async (id, imageUrl) => {
        ...
        try {
            ...
            if (imageUrl.includes('supabase.co')) {
                ...
                // e.g. https://.../storage/v1/object/public/site-gallery/getmidia-produto/123_abc.jpg
                const pathParts = imageUrl.split('/site-gallery/');
                if (pathParts.length > 1) {
                    const filePath = pathParts[1];
                    await supabase.storage.from('site-gallery').remove([filePath]);
                }
            }
