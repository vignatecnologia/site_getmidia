...
const Pricing = ({ isModal = false }) => {
    ...
    const handleSubscribe = async (planId) => {
        ...
        try {
            ...
            // 1. Ensure we have a fresh session (this updates the internal client state)
            ...
            // 2. Fetch user's selected module to pass to checkout
            ...
            // 3. Call the function (the client will automatically inject the Bearer token)
                ...
                {plans.map((plan) => (
                    ...
                    >
                        ...
                        <div className="flex items-center gap-4 mb-6">
                            <div className={`p-3 rounded-xl ${plan.popular ? 'bg-gradient-to-br from-yellow-500/20 to-orange-500/20' : 'bg-gray-700/50'}`}>
                                {plan.icon}
                            </div>
                            <div>
