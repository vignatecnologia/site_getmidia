...
const HowItWorks = () => {
    return (
        <section id="como-funciona" className="py-24 bg-gray-900 relative overflow-hidden">
            <div className="absolute top-0 right-0 -mr-20 -mt-20 w-[600px] h-[600px] bg-primary/10 rounded-full blur-3xl opacity-30" />
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="text-center max-w-3xl mx-auto mb-16">
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-primary/10 border border-primary/20 text-primary text-sm font-bold uppercase tracking-wider mb-6"
                    >
                        Fluxo de Trabalho
                    </motion.div>
                    <motion.h2
                    ...
                    >
                        Como a mágica <span className="text-primary italic">acontece?</span>
                    </motion.h2>
                    <motion.p
                        initial={{ opacity: 0, y: 20 }}
                        whileInView={{ opacity: 1, y: 0 }}
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 relative">
                    ...
                    {steps.map((step, index) => (
                        <motion.div
                            ...
                            className="relative z-10 bg-gray-800/50 backdrop-blur-sm border border-gray-700 p-8 rounded-2xl hover:border-primary/50 transition-all hover:-translate-y-2 group"
                        >
                            <div className="w-16 h-16 bg-gray-900 rounded-2xl border border-gray-700 flex items-center justify-center mb-6 shadow-lg shadow-black/30 group-hover:scale-110 group-hover:bg-gray-800 transition-all">
                                {step.icon}
                            </div>
